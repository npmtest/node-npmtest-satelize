...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-satelize/node_modules/satelize/src/satelize.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-satelize">npmtest-satelize (v0.0.2)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-satelize/node_modules/satelize/src/satelize.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-satelize/node_modules/satelize/src/</a> &#187; satelize.js</div>
</div>
<div class="body">
...
&nbsp;
Satelize.prototype.satelize = <span class="fstat-no" title="function not covered" >function(options, next) {</span>
<span class="cstat-no" title="statement not covered" >  if (!this.initialized) {</span>
<span class="cstat-no" title="statement not covered" >    return next(new Error('db not loaded yet'));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var data = this.db.getGeoDataSync(options.ip);</span>
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Mon Apr 17 2017 22:04:38 GMT+0000 (UTC)</div>
</div>
</body>
</html>
